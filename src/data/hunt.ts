...
export const ITEMS: HuntItem[] = [
  {
    ...
    notes: [
      ...
      "Factory-wrecked card is still a peg buy. List as damaged; expect well under clean.",
    ],
  },
  {
    id: "hw-cuda-yellow",
  ...
  },
  {
    ...
    soldUnknown: true,
    where: HW_WHERE,
    notes: ["Purple Super. Case N leftover. Buy at the peg, don't expect much."],
  },
  {
    id: "hw-f40-sth",
    ...
    where: HW_WHERE,
    photo: "f40",
    notes: ["Black/gray Spectraflame. A–L cases are picked over, still buy any Super at the peg."],
  },
  {
    id: "hw-civic-sth",
  ...
  },
  {
    ...
    name: "Drift-Ender",
    category: "hot-wheels",
    group: "Slower supers · still a peg buy",
    tonight: true,
    tonightRank: 20,
    compact: true,
    verdict: "buy",
  ...
  },
  {
    ...
    where: HW_WHERE,
    notes: [
      "Still a peg buy on a Super. List it as damaged. Expect well under a clean card.",
    ],
  },
  {
...
export const DECODER = {
  hw: [
    "Gold flame + Spectraflame + rubber tires + tiny TH = Super. Buy at the peg.",
  ...
  mb: ["Yellow SUPER CHASE bar, rubber tires, SC on the car. Peg price. Do not buy from collector sites."],
