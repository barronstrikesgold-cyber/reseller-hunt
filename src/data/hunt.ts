...
export const ITEMS: HuntItem[] = [
  {
    ...
    soldUnknown: true,
    shelfDollars: 1,
    buyLine: "Case P Super · shelf about $1",
    saleLine: "No settled sale",
    where: HW_WHERE,
    notes: [
  ...
  {
    id: "hw-skyline-th",
    name: "Black Nissan Skyline HT 2000GT-X",
    category: "hot-wheels",
    group: "Finds",
    tonight: true,
    tonightRank: 2,
    ...
    soldUnknown: true,
    shelfDollars: 1,
    buyLine: "Case P regular TH · shelf about $1",
    saleLine: "No settled sale",
    where: HW_WHERE,
    notes: [
  ...
  },
  {
    ...
    soldUnknown: true,
    shelfDollars: 1,
    buyLine: "Case Q Super · shelf about $1",
    saleLine: "No settled sale",
    secondary: {
  ...
  },
  {
    ...
    sold: {
      dollars: 122,
      kind: "tracked-average",
      note: "August 2026 tracked average $122 across 8 sales. Not one store receipt.",
    },
    shelfDollars: 1,
    buyLine: "Super · shelf about $1",
    saleLine: "August 2026 tracked average $122",
    where: HW_WHERE,
  ...
  },
  {
    ...
    sold: {
      dollars: 73,
      kind: "tracked-average",
      note: "Tracker about $73. Not a dated single sale.",
    },
    shelfDollars: 1,
    buyLine: "Super · shelf about $1",
    saleLine: "Tracker about $73",
    where: HW_WHERE,
  },
  {
    id: "hw-elise-sth",
    ...
    tonightRank: 6,
    verdict: "buy",
    idRule: `${SUPER_ID}. Orange Spectraflame. Card says Lotus Sport Elise, not Elite.`,
    mark: "gold-flame",
    paint: "#e85d04",
    caseCode: "H",
    buyPrice: PEG,
    ...
    sold: {
      dollars: 50,
      kind: "tracked-average",
      note: "Closer to $50. Not the earlier $67.",
    },
    shelfDollars: 1,
    buyLine: "Orange Super · shelf about $1",
    saleLine: "Closer to $50",
    where: HW_WHERE,
  },
  {
  ...
  {
    id: "mb-integra",
    name: "Yellow '97 Integra Type R Super Chase",
    category: "matchbox",
    group: "Finds",
    tonight: true,
    tonightRank: 7,
    ...
    secondary: {
      amount: "$40–$50",
      kind: "shop-ask",
      note: "Shop ask. Not a sold.",
    },
    soldUnknown: true,
    shelfDollars: 1,
    buyLine: "Super Chase · shelf about $1",
    saleLine: "No settled sale",
    where: HW_WHERE,
    notes: [
...
export function itemPhoto(item: HuntItem) {
  return `/photos/${item.id}.jpg`;
}

export function saleLine(item: HuntItem) {
  return item.saleLine ?? (item.sold ? item.sold.note : "No settled sale");
}

export function buyLine(item: HuntItem) {
  if (item.buyLine) return item.buyLine;
  const bits: string[] = [];
